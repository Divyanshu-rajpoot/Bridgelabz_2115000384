...
public class Level2_Question8 {
    public static void main(String[] args) {
        ...
        for (int i = 0; i < numStudents; i++) {
            ...
            System.out.println("Student number " + (i + 1) + " Marks in Physics: " + marks[i][0]
                    + ", Marks in Chemistry: " + marks[i][1] + ", Marks in Maths: " + marks[i][2] + ", Percentage: "
                    + percentages[i] + ", Grade: " + grades[i] + ", Remarks: " + remarks);
        }
        sc.close();
    }
}
