...
public class BankingSystem {
    ...
    public static void main(String[] args) {
        SavingsAccount savingsAccount = new SavingsAccount("92293", "Divya", 10000, 5);
        CurrentAccount currentAccount = new CurrentAccount("48292", "Divyanshu", 2000);
        PersonalLoanAccount loanAccount = new PersonalLoanAccount("LA123", "Prince", 8000, 4);
